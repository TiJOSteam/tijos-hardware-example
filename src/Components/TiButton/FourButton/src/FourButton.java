...
class FourButtonEventListener implements ITiButtonEventListener {
	...
	public void onPressed(TiButton arg0) {
		System.out.println("onPressed"+"  time(us):"+arg0.getEventTime()+"  buttonPinID:"+arg0.getSignalPinID());		
	}
	...
	public void onReleased(TiButton arg0) {
		System.out.println("onReleased"+"  time(us):"+arg0.getEventTime()+"  buttonPinID:"+arg0.getSignalPinID());		
	}	
}
