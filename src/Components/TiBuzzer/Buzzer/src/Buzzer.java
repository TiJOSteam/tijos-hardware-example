 ...
 * 3.“资源使用”：使用tijos.framework.transducer.buzzer.TiBuzzer类中的<code>turnOn<code>以及<code>turnOff<code>控制蜂鸣器的开关<br>
 * <p>
 * 
 * @author Jason
 *
...
public class Buzzer {
	...
	public static void main(String[] args) {
		...
		try {
			...
			/*
			 * 资源绑定， 创建TiBuzzer的对象buzzer并将gpio0和gpioPin0与其绑定 默认使用低电平控制蜂鸣器开启
			 */
